...
public:
	...
	void render(SDL_Texture* p_tex, int width, int height);
	...
	void display();
	void cleanUp();
    void drawCircle(int centreX, int centreY, int radius, SDL_Color color, bool fill);
	SDL_Renderer* getRenderer();
	SDL_Window* getWindow();

	static void  handleWindowResize(int p_w, int p_h);
	static int getWidth();
